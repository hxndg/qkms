...
func main() {
	...
	err = qkms_server.Init(viper.GetString("SERVER_CERT_PATH"), viper.GetString("SERVER_KEY_PATH"), viper.GetString("CA_CERT_PATH"), viper.GetString("CA_KEY_PATH"), viper.GetString("CRL_FILE_PATH"), db_config, "config/rbac_model.conf")
	if err != nil {
