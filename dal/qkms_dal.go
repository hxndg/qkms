...
func (d *BaseDal) Init(cfg DBConfig) error {
	...
	d.DB = db
	//自动迁移，如果表已经存在不会重新创建。
	d.DB.AutoMigrate(&qkms_model.AccessKey{}, &qkms_model.KeyEncryptionKey{}, &qkms_model.KeyAuthorizationPolicy{}, &qkms_model.User{}, &qkms_model.Role{}, &qkms_model.RevokeCert{}, &qkms_model.NameSpace{})
	return err
}
